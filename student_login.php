...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="student_login.css" class="css">
      ...
      <a class="text-decoration-none fs-3  text-dark px-3" href="main.php">X</a>
        ...
        <div class="row cbg">
                    ...
                    <div class="col-lg-6">
                        ...
                        <img class="img-fluid im1" src="picture/lg1.jpg" alt="logo">
    ...
    <?php                                                                        //for signup
            ...
            if(isset($_POST['signup'])){        //post methode
                ...
                $cpassword=$_POST['cpassword'];
                    ...
                    $existsql="SELECT * FROM `student` WHERE username='$username'";  //select methode for exist username
                    ...
                    $num=mysqli_num_rows($result);
                     ...
                     if ($num>0) {               //if username exist
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            ...
                            $sql="INSERT INTO `student` ( `username`, `password`,`email`, `image`, `date`) VALUES ( '$username', '$hash','$email','$image', current_timestamp())";
    ...
    ?>      
                    ...
                    if(isset($_POST['login'])){       //post methode
                        ...
                        while ($row=mysqli_fetch_assoc($rs)) {
                            ...
                            if (password_verify($password,$row['password'])) {
                                ...
                                header("location:student_panel.php");  //locate the location 
            ...
            <nav>
                ...
                <div class="container d-flex justify-content-center">
                        ...
                        <h2 class="text-center my-4"> Student Signup</h2>
                        <div class="mb-3">
                        ...
                        <script>
                            ...
                            function toggle1(){
                                ...
                                if (state) {
                                    ...
                                    state=true;
                                    document.getElementById("eye").style.color='#316D6D';
                                }
                            }
                        </script>
                        ...
                        <script>
                            ...
                            function toggle2(){
                                ...
                                if (state) {
                                    ...
                                    setAttribute("type","text");
                                    state=true;
                                    document.getElementById("eye2").style.color='#316D6D';
                                }
                            }
                        </script>
                        ...
                        <script>
                            ...
                            function toggle3(){
                                ...
                                if (state) {
                                    ...
                                    setAttribute("type","text");
                                    state=true;
                                    document.getElementById("eye3").style.color='#316D6D';
                                }
                            }
                        </script>
