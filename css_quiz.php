...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css_smquiz.css" class="css">
  ...
  <a class="navbar-brand fs-2 hed" href="#"><img class="im" src="picture/logo1.png" alt="logo">Quizi</a>
    ...
    <h3 class="text-center fw-bold mt-3 ht">Course: CSS</h3>
    ...
    <script src="css_squiz_script.js"></script>
