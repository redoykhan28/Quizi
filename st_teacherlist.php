...
<html lang="en">
  ...
  <a class="navbar-brand fs-4 hed" href="#"><img class="im" src="picture/logo2.png" alt="logo">Quizi</a>
      ...
      <li class="dropdown d-flex justify-content-end dm">
          <a class="nav-link dropdown-toggle a1 p-1  text-light " href="" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <li><a class="dropdown-item" href="st_logout.php">Logout</a></li>
               ...
               <div class="row r1">
                ...
                <div class="col-lg-8 cl1 px-5">
                 ...
                 <h3 class="text-center"> <img class="img-fluid imm" src="picture/cm.png" alt="">Teachers List</h3>
                 <hr>
              ...
              <hr>
                  ...
                  <img class="img-fluid im1 mt-5" src="picture/sst2.gif" alt="logo">
