...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="javascript_smquiz.css" class="css">
  ...
  <a class="navbar-brand fs-2 hed" href="main.php"><img class="im" src="logo1.png" alt="logo">Quizi</a>
    <ul class="d-flex">
    ...
    <h3 class="text-center fw-bold mt-3 ht">Course: JavaScript</h3>
    <span class="time mt-3 d-flex justify-content-center"></span>
    ...
    <script src="javascript_squiz_script.js"></script>
