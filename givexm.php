         ...
         ?>"
            ...
            <li><a class="dropdown-item" href="st_logout.php">Logout</a></li>
               ...
               <div class="row r1">
                ...
                <h3 class="text-center"><img class="img-fluid imm" src="picture/hand2.png" alt="">Exam List</h3>
            ...
            ?>
              ...
              <footer class="py-1">
                ...
                <script type="text/javascript">
                  function set_exam_type_session(catagory)
                  {
                      ...
                      xmlhttp.open("GET","forajax/set_exam_type_session.php?catagory="+ catagory,true);
                      xmlhttp.send(null);
                  }
              </script>
