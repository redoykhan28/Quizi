...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="bootstrap_squiz.css" class="css">
    ...
    <title>Bootstrap Quiz Test</title>
  </head>
  <body>
  ...
  <a class="navbar-brand fs-2 hed" href="#"><img class="im" src="picture/logo1.png" alt="logo">Quizi</a>
    ...
    <h3 class="text-center fw-bold mt-3 ht">Course: Bootstrap</h3>
    ...
    <script src="bootstrap_squiz_script.js"></script>
