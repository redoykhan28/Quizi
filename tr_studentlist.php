            ...
            <li><a class="dropdown-item" href="tr_logout.php">Logout</a></li>
               ...
               <div class="row r1">
                ...
                if (isset($_GET['delete'])) {        //get/post connection
                  ...
                  $sql= "DELETE FROM  `student` WHERE id ='$id'";     // deletation
                  $result=mysqli_query($conn,$sql);
                  if ($result) {
...
<h3 class="text-center"><img class="img-fluid imm" src="picture/hand2.png" alt="">Student List</h3>
                 <hr>
                ...
                <?php
                  ...
                  $result=mysqli_query($conn,$sql);
                          ...
                          ?> 
                              ...
                              <td>
                              <a href="tr_studentlist.php?delete=<?php echo $row['id'];?>"
              ...
              <hr>
                  ...
                  <img class="img-fluid d-flex justify-content-center im1 mt-5" src="picture/classroom.gif" alt="logo">
