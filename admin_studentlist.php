...
<h3 class="text-center"><img class="img-fluid imm" src="picture/hd.png" alt="">Student List</h3>
               <hr>
                ...
                <?php
                  ...
                  $result=mysqli_query($conn,$sql);
                          ...
                          ?> 
                              ...
                              <td>
                              <a href="admin_update_studentlist.php?edit=<?php echo $row['id'];?>"
                              class="btn bt1">Update</a> 
                             
                              <a href="admin_studentlist.php?delete=<?php echo $row['id'];?>"
